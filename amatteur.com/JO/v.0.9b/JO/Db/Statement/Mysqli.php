 ...
 * @see JO_Db_Statement
 */
require_once 'JO/Db/Statement.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class JO_Db_Statement_Mysqli extends JO_Db_Statement
{
     ...
     * @param  string $sql
     * @return void
     * @throws JO_Db_Statement_Mysqli_Exception
     */
    public function _prepare($sql)
    {
        ...
        if ($this->_stmt === false || $mysqli->errno) {
            /**
             * @see JO_Db_Statement_Mysqli_Exception
             */
            require_once 'JO/Db/Statement/Mysqli/Exception.php';
            throw new JO_Db_Statement_Mysqli_Exception("Mysqli prepare error: " . $mysqli->error, $mysqli->errno);
        }
    }
    ...
    public function _execute(array $params = null)
    {
        ...
        if ($retval === false) {
             ...
             */
            require_once 'JO/Db/Statement/Mysqli/Exception.php';
            throw new JO_Db_Statement_Mysqli_Exception("Mysqli statement execute error : " . $this->_stmt->error, $this->_stmt->errno);
        }
        ...
        if ($this->_meta === null) {
            ...
            if ($this->_stmt->errno) {
                 ...
                 */
                require_once 'JO/Db/Statement/Mysqli/Exception.php';
                throw new JO_Db_Statement_Mysqli_Exception("Mysqli statement metadata error: " . $this->_stmt->error, $this->_stmt->errno);
            }
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            default:
                 ...
                 */
                require_once 'JO/Db/Statement/Mysqli/Exception.php';
                throw new JO_Db_Statement_Mysqli_Exception("Invalid fetch mode '$style' specified");
                break;
        }
        return $row;
    }
    ...
    public function nextRowset()
    {
         ...
         */
        require_once 'JO/Db/Statement/Mysqli/Exception.php';
        throw new JO_Db_Statement_Mysqli_Exception(__FUNCTION__.'() is not implemented');
    }
