 ...
 * are re-thrown as JO_Db_Statement_Exception.
 *
 * @category   JO
 * @package    JO_Db
 * @subpackage Statement
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class JO_Db_Statement_Pdo extends JO_Db_Statement implements IteratorAggregate
{
    ...
    public function _execute(array $params = null)
    {
        try {
            ...
            require_once 'JO/Db/Statement/Exception.php';
            throw new JO_Db_Statement_Exception($e->getMessage(), (int) $e->getCode(), $e);
        }
    }
