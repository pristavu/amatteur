...
/**
 * @see JO_Db_Statement_Pdo
 */
require_once 'JO/Db/Statement/Pdo.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class JO_Db_Adapter_Pdo_Abstract extends JO_Db_Adapter_Abstract
{
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'JO_Db_Statement_Pdo';
    ...
    protected function _connect()
    {
        ...
        if (!extension_loaded('pdo')) {
            ...
            throw new JO_Db_Adapter_Exception('The PDO extension is required for this adapter but the extension is not loaded');
        }
        ...
        if (!in_array($this->_pdoType, PDO::getAvailableDrivers())) {
             ...
             */
            require_once 'JO/Db/Adapter/Exception.php';
            throw new JO_Db_Adapter_Exception('The ' . $this->_pdoType . ' driver is not currently installed');
        }

        // create PDO connection
        $q = $this->_profiler->queryStart('connect', JO_Db_Profiler::CONNECT);
    ...
    public function exec($sql)
    {
        ...
        try {
            ...
            if ($affected === false) {
                 ...
                 */
                require_once 'JO/Db/Adapter/Exception.php';
                throw new JO_Db_Adapter_Exception($errorInfo[2]);
            }
    ...
    public function setFetchMode($mode)
    {
        ...
        switch ($mode) {
            ...
            default:
                 ...
                 */
                require_once 'JO/Db/Adapter/Exception.php';
                throw new JO_Db_Adapter_Exception("Invalid fetch mode '$mode' specified");
                break;
        }
    }
