...
/**
 * @see JO_Db_Statement_Sqlsrv
 */
require_once 'JO/Db/Statement/Sqlsrv.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class JO_Db_Adapter_Sqlsrv extends JO_Db_Adapter_Abstract
{
    /**
    ...
    protected $_numericDataTypes = array(
        ...
        'MONEY'              => JO_Db::FLOAT_TYPE,
        'NUMERIC'            => JO_Db::FLOAT_TYPE,
        'REAL'               => JO_Db::FLOAT_TYPE,
        'SMALLMONEY'         => JO_Db::FLOAT_TYPE,
    );
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'JO_Db_Statement_Sqlsrv';

    /**
     * Creates a connection resource.
     *
     * @return void
     * @throws JO_Db_Adapter_Sqlsrv_Exception
     */
    protected function _connect()
    {
        ...
        if (!extension_loaded('sqlsrv')) {
            /**
             * @see JO_Db_Adapter_Sqlsrv_Exception
             */
            require_once 'JO/Db/Adapter/Sqlsrv/Exception.php';
            throw new JO_Db_Adapter_Sqlsrv_Exception('The Sqlsrv extension is required for this adapter but the extension is not loaded');
        }
        ...
        if (!$this->_connection) {
             ...
             */
            require_once 'JO/Db/Adapter/Sqlsrv/Exception.php';
            throw new JO_Db_Adapter_Sqlsrv_Exception(sqlsrv_errors());
        }
    }
    ...
    public function setTransactionIsolationLevel($level = null)
    {
        ...
        switch ($level) {
            ...
            default:
                require_once 'JO/Db/Adapter/Sqlsrv/Exception.php';
                throw new JO_Db_Adapter_Sqlsrv_Exception("Invalid transaction isolation level mode '$level' specified");
        }

        if (!sqlsrv_query($this->_connection, "SET TRANSACTION ISOLATION LEVEL $sql;")) {
            require_once 'JO/Db/Adapter/Sqlsrv/Exception.php';
            throw new JO_Db_Adapter_Sqlsrv_Exception("Transaction cannot be changed to '$level'");
        }
    ...
    public function describeTable($tableName, $schemaName = null)
    {
        ...
        $primaryKeysResult = $stmt->fetchAll(JO_Db::FETCH_NUM);
    ...
    public function setFetchMode($mode)
    {
        switch ($mode) {
            ...
            case JO_Db::FETCH_BOUND: // bound to PHP variable
                require_once 'JO/Db/Adapter/Sqlsrv/Exception.php';
                throw new JO_Db_Adapter_Sqlsrv_Exception('FETCH_BOUND is not supported yet');
                break;
            default:
                require_once 'JO/Db/Adapter/Sqlsrv/Exception.php';
                throw new JO_Db_Adapter_Sqlsrv_Exception("Invalid fetch mode '$mode' specified");
                break;
        }
    }
     ...
     */
     public function limit($sql, $count, $offset = 0)
     {
        ...
        if ($count <= 0) {
            require_once 'JO/Db/Adapter/Exception.php';
            throw new JO_Db_Adapter_Exception("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
            /** @see JO_Db_Adapter_Exception */
            require_once 'JO/Db/Adapter/Exception.php';
            throw new JO_Db_Adapter_Exception("LIMIT argument offset=$offset is not valid");
        }
