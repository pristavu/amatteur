...
class JO_Db_Profiler_Query
{
    ...
    /**
     * One of the JO_Db_Profiler constants for query type, set by $queryType argument in constructor.
     *
     * @var integer
     */
     ...
     * type (one of the JO_Db_Profiler::* constants).
     *
     * @param  string  $query
    ...
    /**
     * Get the type of this query (one of the JO_Db_Profiler::* constants)
     *
     * @return integer
     */
