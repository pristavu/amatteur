...
/** JO_Wildfire_Plugin_FirePhp */
require_once 'JO/Wildfire/Plugin/FirePhp.php';

/** JO_Wildfire_Plugin_FirePhp_TableMessage */
require_once 'JO/Wildfire/Plugin/FirePhp/TableMessage.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class JO_Db_Profiler_Firebug extends JO_Db_Profiler
{
    /**
     ...
     * @var JO_Wildfire_Plugin_FirePhp_TableMessage
     */
    ...
    public function __construct($label = null)
    {
        $this->_label = $label;
        if(!$this->_label) {
            $this->_label = 'JO_Db_Profiler_Firebug';
        }
    }
    ...
    public function setEnabled($enable)
    {
        ...
        if ($this->getEnabled()) {
            ...
            if (!$this->_message) {
                $this->_message = new JO_Wildfire_Plugin_FirePhp_TableMessage($this->_label);
                ...
                JO_Wildfire_Plugin_FirePhp::getInstance()->send($this->_message);
            }
