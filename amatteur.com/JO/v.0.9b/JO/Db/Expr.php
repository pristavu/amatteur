 ...
 * is that you can use JO_Db_Expr in the JO_Db_Select::order() method to
 ...
 * specified to methods of JO_Db classes, if the value is an instance of
 * JO_Db_Expr instead of a plain string, then the expression is not quoted.
