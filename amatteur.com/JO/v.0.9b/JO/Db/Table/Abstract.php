...
abstract class JO_Db_Table_Abstract
{
    ...
    protected static function _setupMetadataCache($metadataCache)
    {
        ...
        if (!$metadataCache instanceof JO_Cache_Core) {
            require_once 'JO/Db/Table/Exception.php';
            throw new JO_Db_Table_Exception('Argument must be of type JO_Cache_Core, or a Registry key where a JO_Cache_Core object is stored');
        }
