 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class JO_Db_Table_Rowset_Abstract implements SeekableIterator, Countable, ArrayAccess
{
    /**
    ...
    /**
     * JO_Db_Table_Abstract class name.
     *
     * @var string
     */
    ...
    /**
     * JO_Db_Table_Row_Abstract class name.
     *
     * @var string
     */
    ...
    /**
     * Collection of instantiated JO_Db_Table_Row objects.
     *
     * @var array
     */
     ...
     *
     * @return JO_Db_Table_Rowset_Abstract Fluent interface.
     */
     ...
     * Required by interface Iterator.
     *
     * @return JO_Db_Table_Row_Abstract current element from the collection
     */
     ...
     * @return JO_Db_Table_Rowset_Abstract
     * @throws JO_Db_Table_Rowset_Exception
     */
    public function seek($position)
    {
        $position = (int) $position;
        if ($position < 0 || $position >= $this->_count) {
            require_once 'JO/Db/Table/Rowset/Exception.php';
            throw new JO_Db_Table_Rowset_Exception("Illegal index $position");
        }
    ...
    public function offsetGet($offset)
    {
        ...
        if ($offset < 0 || $offset >= $this->_count) {
            require_once 'JO/Db/Table/Rowset/Exception.php';
            throw new JO_Db_Table_Rowset_Exception("Illegal index $offset");
        }
    ...
    /**
     * Returns a JO_Db_Table_Row from a known position into the Iterator
     *
    ...
    public function getRow($position, $seek = false)
    {
        ...
        try {
            $this->seek($position);
            $row = $this->current();
        } catch (JO_Db_Table_Rowset_Exception $e) {
            require_once 'JO/Db/Table/Rowset/Exception.php';
            throw new JO_Db_Table_Rowset_Exception('No row could be found at position ' . (int) $position, 0, $e);
        }
        if ($seek == false) {
            $this->seek($key);
        }
