 ...
 * @since      2008-03-13
 */
class JO_Phpthumb_Factory_Imagick_Phmagick_Plugins_Color {
	function darken(JO_Phpthumb_Factory_Imagick_Phmagick $p ,$alphaValue = 50){
     ...
     */
    function brighten(JO_Phpthumb_Factory_Imagick_Phmagick $p, $alphaValue = 50){
     ...
     */
//    function toGrayScale(JO_Phpthumb_Factory_Imagick_Phmagick $p){
...
//    }
	...
	function toGreyScale(JO_Phpthumb_Factory_Imagick_Phmagick $p, $enhance=2){
		$cmd   = $p->getBinary('convert');
		$cmd .= ' -modulate 100,0 ' ;
     ...
     */
    function invertColors(JO_Phpthumb_Factory_Imagick_Phmagick $p){
        $cmd  = $p->getBinary('convert');
        $cmd .= ' "' . $p->getSource() .'"';
        $cmd .= ' -negate ';
        $cmd .= ' "' . $p->getDestination() .'"';
    ...
    function sepia(JO_Phpthumb_Factory_Imagick_Phmagick $p, $tone = 90){
		$cmd   = $p->getBinary('convert');
		$cmd .= ' -sepia-tone '. $tone .'% ' ;
		$cmd .= ' -modulate 100,50 ' ;
		$cmd .= ' -normalize ' ;
