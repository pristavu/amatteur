 ...
 * @since      2008-03-13
 */
class JO_Phpthumb_Factory_Imagick_Phmagick_Plugins_Transform {
    function rotate (JO_Phpthumb_Factory_Imagick_Phmagick $p,$degrees=45){
     ...
     * @return unknown_type
     */
    function flipVertical(JO_Phpthumb_Factory_Imagick_Phmagick $p){
        $cmd  = $p->getBinary('convert');
        $cmd .= ' -flip ' ;
        $cmd .= ' "' . $p->getSource() .'"';
        $cmd .= ' "' . $p->getDestination() .'"';
