 ...
 * @subpackage Core
 */
class JO_Phpthumb_Factory_Imagick extends JO_Phpthumb_Base
{
	/**
	...
	public function crop ($startX, $startY, $cropWidth, $cropHeight)
	{
		...
		$this->workingImage->crop($cropWidth, $cropHeight, $startY, $startX, JO_Phpthumb_Factory_Imagick_Phmagick_Gravity::None); 
