 ...
 * @subpackage Core
 */
class JO_Phpthumb_Factory {
	
	const LIB_GD 			= 'gd';
	const LIB_IMAGEMAGICK 	= 'imagick';
	 ...
	 * @var string
	 */
	public static $defaultImplemenation = JO_Phpthumb_Factory::LIB_GD;
	/**
	...
	public static function create ($filename = null, $options = array(), $isDataStream = false)
	{
		...
		(
				'imagick'	=> 'JO_Phpthumb_Factory_Imagick',
				'gd' 		=> 'JO_Phpthumb_Factory_Gd'
		);
