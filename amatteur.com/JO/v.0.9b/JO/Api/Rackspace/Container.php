 ...
 */
class JO_Api_Rackspace_Container {
	public $cfs_auth;
	public $cfs_http;
	public $name;
	public $object_count;
	 ...
	 * @throws JO_Api_Rackspace_Exception_Syntax invalid Container name
	 */
	function __construct(&$cfs_auth, &$cfs_http, $name, $count=0,
			$bytes=0, $docdn=True)
	{
		if (strlen($name) > JO_Api_Rackspace_Authentication::MAX_CONTAINER_NAME_LEN) {
			throw new JO_Api_Rackspace_Exception_Syntax("Container name exceeds "
					. "maximum allowed length.");
		}
		if (strpos($name, "/") !== False) {
			throw new JO_Api_Rackspace_Exception_Syntax(
	 ...
	 * @throws JO_Api_Rackspace_Exception_Cdnnotenabled CDN functionality not returned during auth
	...
	*/
			...
			*/
			 ...
			 * # ... authentication code excluded (see previous examples) ...
			 ...
			 list($status,$reason) = $this->cfs_http->remove_cdn_container($this->name);
			 			...
			 			* @return obj JO_Api_Rackspace_Object instance
			 			*/
			 			function create_object($obj_name=NULL)
			 			{
			 			return new JO_Api_Rackspace_Object($this, $obj_name);
			 			}
			 			...
			 			* # to obtain the object's data.
			 			 ...
			 			 */
			 			 ...
			 			 {
			 			 return new JO_Api_Rackspace_Object($this, $obj_name, True);
			 			 }
			 			...
			 			* # to obtain the object's data.
			 			 * #
			 			 * $pic = $public_container->exists_object("baby.jpg");
			 			 * </code>
			 			 *
			 			 * @param string $obj_name name of storage Object
			 			 * @return obj JO_Api_Rackspace_Object instance
			 			 */
			 			 function exists_object($obj_name=NULL)
			 			 {
			 			 return new JO_Api_Rackspace_Object($this, $obj_name, false);
			 			 }
			 			 ...
			 			 * # with the "path" argument.
			 			 	...
			 			 	* </code>
			 			 	 ...
			 			 	 */
			 			 	 ...
			 			 	 if(!isset($obj['subdir'])) {
			 			 	 $tmp = new JO_Api_Rackspace_Object($this, $obj["name"], False, False);
			 			 	...
			 			 	*
			 			 		...
			 			 		* @throws JO_Api_Rackspace_Exception_Syntax invalid Object/Container name
			 			 		* @throws JO_Api_Rackspace_Exception_Nosuchobject remote Object does not exist
			 			 		* @throws JO_Api_Rackspace_Exception_Invalidresponse unexpected response
			 			 		*/
			 			 		...
			 			 		$obj_name = NULL;
			 			 		if (is_object($obj)) {
			 			 		if (get_class($obj) == "JO_Api_Rackspace_Object") {
			 			 		$obj_name = $obj->name;
			 			 		}
			 			 		}
			 			 		if (is_string($obj)) {
			 			 		...
			 			 		if (!$obj_name) {
			 			 		throw new JO_Api_Rackspace_Exception_Syntax("Object name not set.");
			 			 		}
	...
	if (get_class($container_target) == "JO_Api_Rackspace_Container") {
	...
	throw new JO_Api_Rackspace_Exception_Syntax("Container name target not set.");
	}
	...
	throw new JO_Api_Rackspace_Exception_Nosuchobject($m);
	}
	if ($status < 200 || $status > 299) {
	throw new JO_Api_Rackspace_Exception_Invalidresponse(
	"Invalid response (".$status."): ".$this->cfs_http->get_error());
				...
				* <code>
					...
					* @param obj $container_source name or instance of source Container
						...
						*/
						...
						if (get_class($container_source) == "JO_Api_Rackspace_Container") {
						...
						throw new JO_Api_Rackspace_Exception_Syntax("Container name source not set.");
						}
						...
						* $conn = new JO_Api_Rackspace_Connection($auth);
						 ...
						 * @throws JO_Api_Rackspace_Exception_Syntax invalid Object name
						 * @throws JO_Api_Rackspace_Exception_Nosuchobject remote Object does not exist
						 * @throws JO_Api_Rackspace_Exception_Invalidresponse unexpected response
						 */
						...
						*/
						...
						$elements = explode('/', $path_name, -1);
							...
							$obj = new JO_Api_Rackspace_Object($this, $build_path);
