...
class JO_Api_Twitter_OAuth {
	...
	*/
	function __construct($consumer_key, $consumer_secret, $oauth_token = NULL, $oauth_token_secret = NULL) {
	    $this->sha1_method = new JO_OAuth_Signature_Method_HmacSha1();
	    $this->consumer = new JO_OAuth_Consumer($consumer_key, $consumer_secret);
	    if (!empty($oauth_token) && !empty($oauth_token_secret)) {
			$this->token = new JO_OAuth_Consumer($oauth_token, $oauth_token_secret);
	    } else {
			$this->token = NULL;
	    }
	}
