...
//		var_dump($this->bucket, $this->uri, $this->resource, $url);exit;
		...
		$headers[] = 'Authorization: ' . JO_Api_Amazon::__getSignature(
			$this->verb."\n".
