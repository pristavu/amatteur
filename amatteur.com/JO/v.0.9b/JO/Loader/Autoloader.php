...
class JO_Loader_Autoloader
{
    /**
     * @var JO_Loader_Autoloader Singleton instance
     */
     ...
     */
    protected $_defaultAutoloader = array('JO_Loader', 'loadClass');
    ...
    /**
     * @var array Supported namespaces 'JO' and 'JOX' by default.
     */
    ...
    public static function autoload($class)
    {
        ...
        foreach ($self->getClassAutoloaders($class) as $autoloader) {
            if ($autoloader instanceof JO_Loader_Autoloader) {
    ...
    public function setDefaultAutoloader($callback)
    {
        if (!is_callable($callback)) {
            throw new JO_Exception('Invalid callback specified for default autoloader');
        }
     ...
     *
     * @param  array $autoloaders Array of PHP callbacks (or JO_Loader_Autoloader_Interface implementations) to act as autoloaders
     * @return JO_Loader_Autoloader
     */
    ...
    public function registerNamespace($namespace)
    {
        if (is_string($namespace)) {
            ...
            throw new JO_Exception('Invalid namespace provided');
        }
     ...
     * @return bool|JO_Loader_Autoloader Returns boolean if no argument is passed, object instance otherwise
     */
     ...
     *
     * @param  object|array|string $callback PHP callback or JO_Loader_Autoloader_Interface implementation
