...
class JO_Html_Dom {
    ...
    protected $block_tags = array('root'=>1, 'head'=>1, 'title'=>1, 'body'=>1, 'form'=>1, 'div'=>1, 'span'=>1, 'table'=>1);
    ...
    function __construct($str=null, $lowercase=true, $forceTagsClosed=true, $target_charset=JO_Html_Dom::DEFAULT_TARGET_CHARSET, $stripRN=true, $defaultBRText=JO_Html_Dom::DEFAULT_BR_TEXT) {
        if ($str) {
    ...
    function load($str, $lowercase=true, $stripRN=true, $defaultBRText=JO_Html_Dom::DEFAULT_BR_TEXT) {
        global $debugObject;
    ...
    function load_file() {
        ...
        // Per the JO_Html_Dom repositiry this is a planned upgrade to the codebase.
    ...
    protected function prepare($str, $lowercase=true, $stripRN=true, $defaultBRText=JO_Html_Dom::DEFAULT_BR_TEXT) {
        $this->clear();
        ...
        $this->root = new JO_Html_Dom_Node($this);
        $this->root->tag = 'root';
    ...
    protected function parse() {
        ...
        // text
        $node = new JO_Html_Dom_Node($this);
        ++$this->cursor;
    ...
    protected function read_tag() {
        ...
        if ($this->char==='/') {
            $this->char = (++$this->pos<$this->size) ? $this->doc[$this->pos] : null; // next
            // This represetns the change in the JO_Html_Dom trunk from revision 180 to 181.
