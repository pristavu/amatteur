...
#ADMIN
	...
	'win_this_month' => 'This month\'s profit',
	'clear_win_this_month' => 'This month\'s net profit',
	'referal_money_this_month' => 'Referent program money',
	'user_win_this_month' => 'User\'s profit',
	...
	'referal_earnings' => 'Referal earnings',
...
#FRONT
	...
	'error_not_set_theme_preview' => 'You have to choose a flash preview',
    'error_not_set_video_file' => 'You have to choose a flash file',    
	'error_theme_preview_zip' => 'Flash preview should be ZIP file',
	...
	'error_all_fields_required' => 'You have to fullfil all the fields',
	...
	'error_certificate' => 'You have to buy a flash to get a certificate',
	'error_main_file_flv' => 'Please upload flash file',
	'error_not_set_audio_file' => 'The file you are uploading is not valid flv file',
	...
	'complete_buy_theme' => 'The flash has been successfully bought',
	...
	'complete_bookmark_item' => 'The flash is added to your favorites',
	...
	'complete_delete_bookmark' => 'The flash is removed form your collection',
	...
	'formatting_help' => '
<p>Format your entry with some basic HTML. or here is a refresher:</p>
<p>
...
<p class="smiley-help">
  <img src="/data/images/emoticons/emoticon_evilgrin.png" alt="]:)" />
  <img src="/data/images/emoticons/emoticon_grin.png" alt=":D" />
  <img src="/data/images/emoticons/emoticon_happy.png" alt=":))" />
  <img src="/data/images/emoticons/emoticon_smile.png" alt=":)" />
	<img src="/data/images/emoticons/emoticon_surprised.png" alt=":O" />
	<img src="/data/images/emoticons/emoticon_tongue.png" alt=":P" />
	<img src="/data/images/emoticons/emoticon_unhappy.png" alt=":(" />
	<img src="/data/images/emoticons/emoticon_wink.png" alt=";)" />
</p>	
	',
	...
	'theme_preview_info' => '590x300 JPEG (only if your preview is a full-screen preview and you wish to display a custom image)',
	'video_preview_info' => 'ZIP - Files for Previews',
    'video_file' => 'Preview Source',
	...
	'demo_url_info' => '*Optional* link to a live preview on your own hosting (i.e. http://my-site.com/demo/).',
	'category' => 'Category',
...
==== THIS IS NOT A TAX RECEIPT OR INVOICE ====		
	...
	'what_are_collections_text' => 'Collections are groups of items compiled by different users on a flash.<br /><br />They can be set to Private for personal use, or Public so that they appear on this page and on a user\'s homepage.',
	'ok' => 'OK',
...
# EMAILS
	...
	'email_activate_text' => 'To actovate your profile in {$DOMAIN}, please click the following link:	
...
$langArray['meta_title_help'] = 'It could be said that the title is one of the most important factors for a successful search engine optimization of your website. The title tags should be between 10-60 characters.';
$langArray['meta_keywords_help'] = 'Lately, the meta keyword tag has become the least important tag for the search engines and especially Google. However, it is an easy way to reinforce once again your most important keywords. We recommend its usage as we believe that it may help the SEO process, especially if you follow the rules mentioned below. The keyword tags should contain between 4 and 10 keywords.';
$langArray['meta_description_help'] = 'The description tag should be written in such way that it will show what information your website contains or what your website is about. Write short and clear sentences that will not confuse your visitors. The description tag should be less than 200 characters.';
$langArray['admin_mail_help'] = 'On this email will comes all emails that is related to your system';
$langArray['report_mail_help'] = 'report_mail_help';
$langArray['paypal_email_help'] = 'When you register for PayPal, you use your email address. You can have multiple PayPal emails associated with it. These emails are the unique identities which PayPal uses to associate payments with an account. Those emails are "PayPal emails" and you can use any of those to accept payments.';
$langArray['referal_sum_help'] = 'In this field you can indicate how many products can be purchased by a customer and will be added to the referral commission. For unlimited number of readings commission please enter 0';
$langArray['referal_percent_help'] = 'Percentage of commission for referrals';
$langArray['prepaid_price_discount_help'] = 'From here you can adjust the amount of discount for prepaid purchase. It is possible to enter%. Example: 2% will reduce the price of the product by 2 percent. If you enter only 2 will reduce the price of 2 units of your chosen currency.';
$langArray['extended_price_help'] = 'In this field you can enter a value to be multiplied by the amount of product to purchase a full license. In such a purchase, the product is automatically removed from the site';
$langArray['no_exclusive_author_percent_help'] = 'This field sets the rate for non-exclusive authors';
$langArray['exclusive_author_percent_help'] = 'This field sets the rate for exclusive authors';
$langArray['site_logo_help'] = 'Site logo show in header';

$langArray['error_theme_preview_zip_images'] = 'Flash preview should contain flash or html files for preview in to the Zip file';
...
$langArray['site_watermark'] = 'Watermark';
