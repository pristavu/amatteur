...
class Helper_AutoEmbed {
  ...
  public function parseUrl($url) {
    ...
    foreach (Helper_AutoEmbed_Stubs::$AutoEmbed_stubs as $stub) { 
  ...
  private function _buildiFrame() {
    ...
    /*if(strpos($source, '?')) {
    	$source .= '&autohide=1&theme=light&hd=1&modestbranding=1&rel=0&showinfo=0&showsearch=0&wmode=transparent&autoplay=1';
    } else {
    	$source .= '?autohide=1&theme=light&hd=1&modestbranding=1&rel=0&showinfo=0&showsearch=0&wmode=transparent&autoplay=1';
    }*/
    ...
    return sprintf('<iframe type="text/html" width="%s" height="%s" src="%s" frameborder="0" allowtransparency="true" ></iframe>', $width, $height, $source);
  }
