...
class Helper_Amazon_S3 {
	...
	*/
	public static function listBuckets($detailed = false) {
		$rest = new Helper_Amazon_S3request('GET', '', '');
	...
	*/
	public static function getBucket($bucket, $prefix = null, $marker = null, $maxKeys = null) {
		$rest = new Helper_Amazon_S3request('GET', $bucket, '');
	...
	*/
	public function putBucket($bucket, $acl = self::ACL_PRIVATE) {
		$rest = new Helper_Amazon_S3request('PUT', $bucket, '');
	...
	*/
	public function deleteBucket($bucket = '') {
		$rest = new Helper_Amazon_S3request('DELETE', $bucket);
		$rest = $rest->getResponse();
	...
	*/
	public static function putObject($input, $bucket, $uri, $acl = self::ACL_PRIVATE, $metaHeaders = array(), $contentType = null) {
		...
		$rest = new Helper_Amazon_S3request('PUT', $bucket, $uri);
	...
	*/
	public static function getObject($bucket = '', $uri = '', $saveTo = false) {
		$rest = new Helper_Amazon_S3request('GET', $bucket, $uri);
		if ($saveTo !== false) {
	...
	*/
	public static function getObjectInfo($bucket = '', $uri = '', $returnInfo = true) {
		$rest = new Helper_Amazon_S3request('HEAD', $bucket, $uri);
		$rest = $rest->getResponse();
	...
	*/
	public static function deleteObject($bucket = '', $uri = '') {
		$rest = new Helper_Amazon_S3request('DELETE', $bucket, $uri);
		$rest = $rest->getResponse();
		if ($rest->error === false && $rest->code !== 204)
			$rest->error = array('code' => $rest->code, 'message' => 'Unexpected HTTP status');
		if ($rest->error !== false) {
